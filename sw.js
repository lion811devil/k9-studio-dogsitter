const CACHE = 'k9-dogsitter-12.7.6';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.6', './config.js?v=12.7.6',
  './js/core.js?v=12.7.6', './js/periods.js?v=12.7.6', './js/settings.js?v=12.7.6',
  './js/pdf-engine.js?v=12.7.6', './js/operations.js?v=12.7.6', './js/app.js?v=12.7.6', './manifest.webmanifest',
