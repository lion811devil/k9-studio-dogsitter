const CACHE = 'k9-dogsitter-12.4.0';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.4.0', './config.js?v=12.4.0',
  './js/core.js?v=12.4.0', './js/periods.js?v=12.4.0', './js/settings.js?v=12.4.0',
  './js/pdf-engine.js?v=12.4.0', './js/operations.js?v=12.4.0', './js/app.js?v=12.4.0', './manifest.webmanifest',
