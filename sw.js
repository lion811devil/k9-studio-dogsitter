const CACHE = 'k9-dogsitter-12.7.1';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.1', './config.js?v=12.7.1',
  './js/core.js?v=12.7.1', './js/periods.js?v=12.7.1', './js/settings.js?v=12.7.1',
  './js/pdf-engine.js?v=12.7.1', './js/operations.js?v=12.7.1', './js/owner-recovery.js?v=12.7.1', './js/app.js?v=12.7.1', './manifest.webmanifest',
