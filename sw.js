const CACHE = 'k9-dogsitter-12.7.8';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.8', './config.js?v=12.7.8',
  './js/core.js?v=12.7.8', './js/periods.js?v=12.7.8', './js/settings.js?v=12.7.8',
  './js/pdf-engine.js?v=12.7.8', './js/operations.js?v=12.7.8', './js/app.js?v=12.7.8', './manifest.webmanifest',
