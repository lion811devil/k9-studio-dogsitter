const CACHE = 'k9-dogsitter-12.7.4';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.4', './config.js?v=12.7.4',
  './js/core.js?v=12.7.4', './js/periods.js?v=12.7.4', './js/settings.js?v=12.7.4',
  './js/pdf-engine.js?v=12.7.4', './js/operations.js?v=12.7.4', './js/app.js?v=12.7.4', './manifest.webmanifest',
