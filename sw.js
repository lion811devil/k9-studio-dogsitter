const CACHE = 'k9-dogsitter-9.0.0';
const STATIC = [
  './', './index.html', './css/styles.css?v=9.0.0', './config.js?v=9.0.0',
  './js/core.js?v=9.0.0', './js/periods.js?v=9.0.0', './js/settings.js?v=9.0.0',
  './js/pdf-engine.js?v=9.0.0', './js/app.js?v=9.0.0', './manifest.webmanifest',
