// K9 Studio Dogsitter 12.9.51 — Service Worker aggiornamento affidabile
const K9_SW_VERSION='12.9.51';
...
const APP_SHELL=[
  ...
  './css/styles.css?v=12.9.51',
  './js/core.js?v=12.9.51',
  './js/periods.js?v=12.9.51',
  './js/settings.js?v=12.9.51',
  './js/pdf-engine.js?v=12.9.51',
  './js/operations.js?v=12.9.51',
  './js/app.js?v=12.9.51',
  './assets/logo.png',
  './assets/icon-192.png',
  './assets/icon-512.png'
