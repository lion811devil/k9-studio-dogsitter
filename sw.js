const CACHE = 'k9-dogsitter-12.7.9';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.9', './config.js?v=12.7.9',
  './js/core.js?v=12.7.9', './js/periods.js?v=12.7.9', './js/settings.js?v=12.7.9',
  './js/pdf-engine.js?v=12.7.9', './js/operations.js?v=12.7.9', './js/app.js?v=12.7.9', './manifest.webmanifest',
