const CACHE = 'k9-dogsitter-12.5.2';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.5.2', './config.js?v=12.5.2',
  './js/core.js?v=12.5.2', './js/periods.js?v=12.5.2', './js/settings.js?v=12.5.2',
  './js/pdf-engine.js?v=12.5.2', './js/operations.js?v=12.5.2', './js/app.js?v=12.5.2', './manifest.webmanifest',
