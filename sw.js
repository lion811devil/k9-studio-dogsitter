const CACHE = 'k9-dogsitter-12.7.3';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.3', './config.js?v=12.7.3',
  './js/core.js?v=12.7.3', './js/periods.js?v=12.7.3', './js/settings.js?v=12.7.3',
  './js/pdf-engine.js?v=12.7.3', './js/operations.js?v=12.7.3', './js/app.js?v=12.7.3', './manifest.webmanifest',
