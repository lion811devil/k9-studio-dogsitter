const CACHE = 'k9-dogsitter-11.0.0';
const STATIC = [
  './', './index.html', './css/styles.css?v=11.0.0', './config.js?v=11.0.0',
  './js/core.js?v=11.0.0', './js/periods.js?v=11.0.0', './js/settings.js?v=11.0.0',
  './js/pdf-engine.js?v=11.0.0', './js/operations.js?v=11.0.0', './js/app.js?v=11.0.0', './manifest.webmanifest',
