const CACHE = 'k9-dogsitter-12.7.7';
const STATIC = [
  './', './index.html', './css/styles.css?v=12.7.7', './config.js?v=12.7.7',
  './js/core.js?v=12.7.7', './js/periods.js?v=12.7.7', './js/settings.js?v=12.7.7',
  './js/pdf-engine.js?v=12.7.7', './js/operations.js?v=12.7.7', './js/app.js?v=12.7.7', './manifest.webmanifest',
