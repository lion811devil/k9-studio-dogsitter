(function(){
  ...
  async function createReceiptPdf(data,settings,logoUrl,stampUrl){
    ...
    roundedRect(ctx,x,signY,w,stampH+66,16,'#ffffff',line);drawText(ctx,'Timbro e firma',x+24,signY+34,{font:'16px Arial',color:muted,bold:true});if(stamp)ctx.drawImage(stamp,x+w-stampW-24,signY+28,stampW,stampH);
